    ...
    cards: [
      {
        ...
        content: [
          ...
          { label: '연 1,500만원 초과', value: '종합소득세 합산', note: '고소득자 위험' },
        ],
        tip: '⚡ 핵심 전략: 연금저축 + IRP 합산 연 1,500만원 이내로 인출하면 분리과세 적용 (2023년 세법 개정). 초과분은 최고 45%까지 과세될 수 있으므로 ISA 만기자금으로 보완하세요.',
      },
      {
        title: '최적 인출 순서',
        steps: [
          ...
          { step: '3순위', label: '연금저축·IRP 인출', reason: '80세 이후 3.3%로 가급적 미루되, 연 1,500만원 한도 준수 (2023년 개정)' },
